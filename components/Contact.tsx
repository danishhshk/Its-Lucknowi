...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-16 sm:py-24 mughal-pattern">
      <div className="container mx-auto px-3 sm:px-4">
        <div className="bg-dark-brown/80 backdrop-blur-md rounded-sm border border-gold/20 overflow-hidden flex flex-col lg:flex-row shadow-2xl">
          <div className="lg:w-1/2 p-6 sm:p-8 md:p-12 lg:p-16">
            <h2 className="text-gold font-royal text-xs sm:text-sm tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-2 sm:mb-4">Get In Touch</h2>
            <h3 className="font-royal text-2xl sm:text-3xl md:text-4xl text-white mb-6 sm:mb-8">Visit the Haveli</h3>
            ...
            <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row gap-3 sm:gap-4">
               <a href="tel:+919876543210" className="gold-gradient text-dark-brown px-6 sm:px-8 py-2 sm:py-3 rounded-sm font-bold text-xs sm:text-sm uppercase tracking-widest flex items-center justify-center gap-2 flex-1 sm:flex-none">
                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                 <span className="hidden sm:inline">Call to Reserve</span>
                 <span className="sm:hidden">Call</span>
               </a>
               <a href="https://maps.app.goo.gl/KSH3axYhyUxMAP9g9" target="_blank" rel="noopener noreferrer" className="gold-gradient text-dark-brown px-6 sm:px-8 py-2 sm:py-3 rounded-sm font-bold text-xs sm:text-sm uppercase tracking-widest flex items-center justify-center gap-2 flex-1 sm:flex-none">
